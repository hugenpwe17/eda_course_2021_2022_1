...
-- led[0]	=>  Location: PIN_K6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- led[1]	=>  Location: PIN_K5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- led[2]	=>  Location: PIN_L6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- led[3]	=>  Location: PIN_L7,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \led_ctl[0]~1_combout\ : std_logic;
SIGNAL \key[3]~input_o\ : std_logic;
SIGNAL \key[2]~input_o\ : std_logic;
SIGNAL \led~4_combout\ : std_logic;
SIGNAL \Equal0~7_combout\ : std_logic;
SIGNAL \led_ctl[1]~0_combout\ : std_logic;
...
SIGNAL led_ctl : std_logic_vector(1 DOWNTO 0);
...
-- Equation(s):
-- \Equal0~8_combout\ = (!cnt(17) & (!cnt(16) & !cnt(18)))
...
-- Equation(s):
-- \LessThan0~2_combout\ = (\Equal0~8_combout\ & ((cnt(15)) # ((!cnt(13) & !cnt(14)))))
...
-- Equation(s):
-- \LessThan0~0_combout\ = (!cnt(9) & (!cnt(10) & ((cnt(8)) # (cnt(7)))))
...
-- Equation(s):
-- \LessThan0~1_combout\ = (!cnt(15) & (!cnt(12) & ((cnt(11)) # (\LessThan0~0_combout\))))
...
-- Equation(s):
-- \LessThan0~3_combout\ = (cnt(20)) # ((cnt(19)) # ((\LessThan0~2_combout\ & !\LessThan0~1_combout\)))
...
-- Equation(s):
-- \LessThan0~4_combout\ = (!cnt(23) & ((cnt(22)) # ((cnt(21)) # (!\LessThan0~3_combout\))))
...
-- Equation(s):
-- \Equal0~5_combout\ = (!cnt(5) & (!cnt(6) & (!cnt(11) & !cnt(4))))
...
-- Equation(s):
-- \Equal0~2_combout\ = (!cnt(20) & (!cnt(23) & (!cnt(19) & !cnt(1))))
...
-- Equation(s):
-- \Equal0~3_combout\ = (!cnt(12) & (!cnt(15) & (!cnt(3) & !cnt(2))))
...
-- Equation(s):
-- \Equal0~0_combout\ = (!cnt(18) & (!cnt(17) & (!cnt(0) & !cnt(16))))
...
-- Equation(s):
-- \Equal0~6_combout\ = (!cnt(13) & (!cnt(14) & (!cnt(21) & !cnt(22))))
...
\led_ctl[0]~1\ : cycloneive_lcell_comb
-- Equation(s):
-- \led_ctl[0]~1_combout\ = led_ctl(0) $ (((\Equal0~5_combout\ & (\Equal0~4_combout\ & \Equal0~6_combout\))))
...
-- Equation(s):
-- \led~4_combout\ = (\key[2]~input_o\ & ((!\key[3]~input_o\))) # (!\key[2]~input_o\ & (led_ctl(0)))
...
\led_ctl[1]~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \led_ctl[1]~0_combout\ = led_ctl(1) $ (((led_ctl(0) & \Equal0~7_combout\)))
...
-- Equation(s):
-- \Decoder0~0_combout\ = (led_ctl(1)) # (led_ctl(0))
...
-- Equation(s):
-- \Decoder0~1_combout\ = (led_ctl(1) & led_ctl(0))
...
-- Equation(s):
-- \led~5_combout\ = (\key[2]~input_o\ & ((\key[3]~input_o\))) # (!\key[2]~input_o\ & (led_ctl(0)))
...
-- Equation(s):
-- \Decoder0~2_combout\ = (!led_ctl(1) & led_ctl(0))
...
-- Equation(s):
-- \led[1]~1_combout\ = (\key[1]~input_o\ & (!\led~5_combout\)) # (!\key[1]~input_o\ & ((\Decoder0~2_combout\)))
...
-- Equation(s):
-- \Decoder0~3_combout\ = (led_ctl(1) & !led_ctl(0))
...
-- Equation(s):
-- \led[3]~3_combout\ = (\key[1]~input_o\ & (!\led~5_combout\)) # (!\key[1]~input_o\ & ((\Decoder0~1_combout\)))
