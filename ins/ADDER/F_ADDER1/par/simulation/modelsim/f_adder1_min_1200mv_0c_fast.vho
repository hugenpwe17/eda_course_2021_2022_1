...
ARCHITECTURE structure OF f_adder1 IS
...
SIGNAL \U2|sout~0_combout\ : std_logic;
...
\U2|sout~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \U2|sout~0_combout\ = \ain~input_o\ $ (\cin~input_o\ $ (\bin~input_o\))
...
\U3~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \U3~0_combout\ = (\ain~input_o\ & ((\cin~input_o\) # (\bin~input_o\))) # (!\ain~input_o\ & (\cin~input_o\ & \bin~input_o\))
